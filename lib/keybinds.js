var Keybinds = (function () {
    ...
    Keybinds.prototype.init = function (callback) {
            ...
            switch (modifyer) {
                case "none":
                    if (!event.ctrlKey && !event.shiftKey && !event.altKey)
                        callback(event.keyCode); //console.log("none");
                    break;
                case "shift":
                    if (!event.ctrlKey && event.shiftKey && !event.altKey)
                        console.log("shift");
    ...
    Keybinds.prototype.mouseEventHandler = function () {
    ...
    Keybinds.prototype.setPreventDefault = function (status) {
        this.preventdefault = status;
    };
    return Keybinds;
})();
